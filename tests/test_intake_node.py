...
class TestIntakeNodeValidation:
    ...
    def test_parse_request_with_missing_project_name(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="", project_description="A test project")
    ...
    def test_parse_request_with_missing_project_description(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description="")
    ...
    def test_parse_request_with_none_project_name(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name=None, project_description="A test project")
        with pytest.raises(InvalidRequestError, match="project_name"):
            intake.parse_request(request)
    ...
    def test_parse_request_with_non_string_project_name(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name=123, project_description="A test project")
        with pytest.raises(InvalidRequestError, match="project_name"):
            intake.parse_request(request)
...
class TestIntakeNodeRunIdGeneration:
    ...
    def test_run_id_format(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description="A test project")
...
class TestIntakeNodeSpecificationGeneration:
    ...
    def test_specification_with_provided_scope(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description="A test project", scope="Custom scope")
    ...
    def test_specification_with_provided_constraints(self):
        ...
        request = UserRequest(
            project_name="Test Project", project_description="A test project", constraints=constraints
        )
    ...
    def test_specification_with_provided_resources(self):
        ...
        request = UserRequest(project_name="Test Project", project_description="A test project", resources=resources)
    ...
    def test_specification_infers_infrastructure_domain(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description="Deploy to AWS with Docker containers")
    ...
    def test_specification_infers_testing_domain(self):
        ...
        intake = IntakeNode()
        request = UserRequest(
            project_name="Test Project", project_description="Build a project with comprehensive testing"
        )
...
class TestIntakeNodeEdgeCases:
    ...
    def test_parse_request_with_long_project_name(self):
        ...
        intake = IntakeNode()
        long_name = "A" * 500
        request = UserRequest(project_name=long_name, project_description="A test project")
    ...
    def test_parse_request_with_special_characters(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test-Project_2024!@#", project_description="A test project")
    ...
    def test_parse_request_with_metadata(self):
        ...
        request = UserRequest(project_name="Test Project", project_description="A test project", metadata=metadata)
    ...
    def test_parse_request_with_empty_metadata(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description="A test project", metadata={})
...
class TestIntakeNodePrivateMethods:
    ...
    def test_infer_scope_with_short_description(self):
        ...
        request = UserRequest(project_name="Test", project_description=description, scope=None)
    ...
    def test_infer_scope_with_long_description(self):
        ...
        request = UserRequest(project_name="Test", project_description=long_desc, scope=None)
        spec, _ = intake.parse_request(request)
    ...
    def test_default_constraints_generated(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="A test project", constraints=None)
        spec, _ = intake.parse_request(request)
    ...
    def test_default_resources_generated(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="A test project", resources=None)
        spec, _ = intake.parse_request(request)
    ...
    def test_infer_domains_with_deploy_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Deploy the application")
        spec, _ = intake.parse_request(request)
        assert "infrastructure" in spec.domains
    ...
    def test_infer_domains_with_aws_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Use AWS for hosting")
        spec, _ = intake.parse_request(request)
        assert "infrastructure" in spec.domains
    ...
    def test_infer_domains_with_docker_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Containerize with Docker")
        spec, _ = intake.parse_request(request)
        assert "infrastructure" in spec.domains
    ...
    def test_infer_domains_with_cloud_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Deploy to cloud")
        spec, _ = intake.parse_request(request)
        assert "infrastructure" in spec.domains
    ...
    def test_infer_domains_with_testing_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Include comprehensive testing")
        spec, _ = intake.parse_request(request)
        assert "testing" in spec.domains
    ...
    def test_infer_domains_with_qa_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="QA and verification")
        spec, _ = intake.parse_request(request)
        assert "testing" in spec.domains
    ...
    def test_infer_domains_with_test_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Write test cases")
        spec, _ = intake.parse_request(request)
        assert "testing" in spec.domains
    ...
    def test_infer_domains_with_documentation_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Create documentation")
        spec, _ = intake.parse_request(request)
    ...
    def test_infer_domains_with_api_doc_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Generate API doc")
        spec, _ = intake.parse_request(request)
        assert "documentation" in spec.domains
    ...
    def test_infer_domains_with_document_keyword(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Document the system")
        spec, _ = intake.parse_request(request)
        assert "documentation" in spec.domains
    ...
    def test_infer_dependencies_frontend_depends_on_backend(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build frontend and backend")
        spec, _ = intake.parse_request(request)
        assert "backend" in spec.dependencies.get("frontend", [])
    ...
    def test_infer_dependencies_testing_depends_on_backend(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build with testing and deploy to AWS")
        spec, _ = intake.parse_request(request)
    ...
    def test_infer_dependencies_infrastructure_depends_on_backend(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build backend and deploy to AWS")
        spec, _ = intake.parse_request(request)
    ...
    def test_infer_dependencies_no_frontend_no_dependency(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build backend API only")
        spec, _ = intake.parse_request(request)
    ...
    def test_parse_request_with_empty_constraints_list(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Test", constraints=[])
        spec, _ = intake.parse_request(request)
    ...
    def test_parse_request_with_empty_resources_dict(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Test", resources={})
        spec, _ = intake.parse_request(request)
    ...
    def test_multiple_infrastructure_keywords(self):
        ...
        intake = IntakeNode()
        request = UserRequest(
            project_name="Test", project_description="Deploy to AWS with Docker containers and infrastructure as code"
        )
        spec, _ = intake.parse_request(request)
        assert "infrastructure" in spec.domains
    ...
    def test_case_insensitive_keyword_matching(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="DEPLOY to AWS with DOCKER")
        spec, _ = intake.parse_request(request)
        assert "infrastructure" in spec.domains
...
class TestIntakeNodeCoverageGaps:
    ...
    def test_validate_request_with_non_string_description(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description=123)
        with pytest.raises(InvalidRequestError, match="project_description"):
            intake.parse_request(request)
    ...
    def test_validate_request_with_none_description(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description=None)
        with pytest.raises(InvalidRequestError, match="project_description"):
            intake.parse_request(request)
    ...
    def test_infer_domains_without_any_keywords(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build a simple application")
        spec, _ = intake.parse_request(request)
        assert "backend" in spec.domains
        assert "frontend" in spec.domains
    ...
    def test_infer_dependencies_only_backend_frontend(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build backend and frontend")
        spec, _ = intake.parse_request(request)
    ...
    def test_specification_metadata_preserved_when_none(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Test", metadata=None)
        spec, _ = intake.parse_request(request)
        assert spec.metadata == {}
    ...
    def test_infer_scope_with_empty_string_description(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="")
        with pytest.raises(InvalidRequestError):
            intake.parse_request(request)
    ...
    def test_infer_domains_case_insensitive_infrastructure(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Set up INFRASTRUCTURE")
        spec, _ = intake.parse_request(request)
        assert "infrastructure" in spec.domains
    ...
    def test_specification_has_all_required_fields_populated(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test Project", project_description="A comprehensive test project")
        spec, run_id = intake.parse_request(request)
    ...
    def test_infer_dependencies_testing_has_both_dependencies(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build backend, frontend, and testing")
        spec, _ = intake.parse_request(request)
    ...
    def test_validate_request_accepts_valid_request(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Valid Project", project_description="Valid description")
    ...
    def test_specification_version_always_1_0(self):
        ...
        intake = IntakeNode()
        for i in range(3):
            request = UserRequest(project_name=f"Test {i}", project_description=f"Test description {i}")
            spec, _ = intake.parse_request(request)
            assert spec.version == "1.0"
    ...
    def test_default_constraints_are_meaningful(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Test", constraints=None)
        spec, _ = intake.parse_request(request)
    ...
    def test_default_resources_have_required_keys(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Test", resources=None)
        spec, _ = intake.parse_request(request)
    ...
    def test_specification_domains_are_strings(self):
        ...
        intake = IntakeNode()
        request = UserRequest(project_name="Test", project_description="Build backend, frontend, and deploy to AWS")
        spec, _ = intake.parse_request(request)
    ...
    def test_specification_dependencies_are_lists(self):
        ...
        for _domain, deps in spec.dependencies.items():
