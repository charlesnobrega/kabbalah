...
class TestAgentHealthUpdate:
    ...
    def test_update_agent_health_success(self):
        ...
        module.update_agent_health("agent_1", AgentStatus.HEALTHY, is_responsive=True, error_count=0)
    ...
    def test_update_agent_health_with_errors(self):
        ...
        module.update_agent_health(
            "agent_1", AgentStatus.UNHEALTHY, is_responsive=False, error_count=5, warning_count=2
        )
    ...
    def test_update_agent_health_unregistered_raises_error(self):
        ...
        with pytest.raises(ValueError, match="not registered"):
            module.update_agent_health("agent_1", AgentStatus.HEALTHY, is_responsive=True)
