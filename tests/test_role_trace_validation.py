...
class TestValidateOperationForRole:
    ...
    def test_intake_clarifier_can_parse_request(self):
        ...
        result = module.validate_operation_for_role(
            CanonicalRole.INTAKE_CLARIFIER, OperationCategory.PARSE_REQUEST, "run_001:branch_001:leaf_001"
        )
    ...
    def test_intake_clarifier_cannot_decompose_specification(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.INTAKE_CLARIFIER, OperationCategory.DECOMPOSE_SPECIFICATION, "run_001:branch_001:leaf_001"
        )
    ...
    def test_root_planner_can_decompose_specification(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.ROOT_PLANNER, OperationCategory.DECOMPOSE_SPECIFICATION, "run_001:branch_001:leaf_001"
        )
        assert result is True
    ...
    def test_root_planner_cannot_execute_task(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.ROOT_PLANNER, OperationCategory.EXECUTE_TASK, "run_001:branch_001:leaf_001"
        )
        assert result is False
    ...
    def test_domain_coordinator_can_spawn_leaf_nodes(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.DOMAIN_COORDINATOR, OperationCategory.SPAWN_LEAF_NODES, "run_001:branch_001:leaf_001"
        )
        assert result is True
    ...
    def test_leaf_builder_can_execute_task(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.LEAF_BUILDER, OperationCategory.EXECUTE_TASK, "run_001:branch_001:leaf_001"
        )
        assert result is True
    ...
    def test_leaf_builder_cannot_verify_result(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.LEAF_BUILDER, OperationCategory.VERIFY_RESULT, "run_001:branch_001:leaf_001"
        )
        assert result is False
    ...
    def test_leaf_verifier_can_verify_result(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.LEAF_VERIFIER, OperationCategory.VERIFY_RESULT, "run_001:branch_001:leaf_001"
        )
        assert result is True
    ...
    def test_leaf_auditor_can_audit_operation(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.LEAF_AUDITOR, OperationCategory.AUDIT_OPERATION, "run_001:branch_001:leaf_001"
        )
        assert result is True
    ...
    def test_synthesizer_can_collect_artifacts(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(
            CanonicalRole.SYNTHESIZER_CONSOLIDATOR, OperationCategory.COLLECT_ARTIFACTS, "run_001:branch_001:leaf_001"
        )
        assert result is True
    ...
    def test_all_roles_can_query_artifact(self):
        ...
        for role in CanonicalRole:
            result = module.validate_operation_for_role(
                role, OperationCategory.QUERY_ARTIFACT, "run_001:branch_001:leaf_001"
            )
    ...
    def test_all_roles_can_attach_metadata(self):
        ...
        for role in CanonicalRole:
            result = module.validate_operation_for_role(
                role, OperationCategory.ATTACH_METADATA, "run_001:branch_001:leaf_001"
            )
    ...
    def test_violation_logged_for_unauthorized_operation(self):
        ...
        module.validate_operation_for_role(
            CanonicalRole.INTAKE_CLARIFIER, OperationCategory.EXECUTE_TASK, "run_001:branch_001:leaf_001"
        )
...
class TestValidateOperationForRoleWithLogging:
    ...
    def test_error_message_contains_trace_id(self):
        ...
        is_allowed, error_msg = module.validate_operation_for_role_with_logging(
            CanonicalRole.INTAKE_CLARIFIER, OperationCategory.EXECUTE_TASK, trace_id
        )
        assert is_allowed is False
...
class TestAttachTraceMetadata:
    ...
    def test_attach_metadata_to_artifact(self):
        ...
        result = module.attach_trace_metadata(artifact, trace_id, "Leaf_Builder", "Leaf_Builder", "execute_task")
    ...
    def test_attach_metadata_preserves_original_artifact(self):
        ...
        result = module.attach_trace_metadata(artifact, "run_001:branch_001:leaf_001", "Leaf_Builder", "Leaf_Builder")
    ...
    def test_attach_metadata_includes_timestamp(self):
        ...
        result = module.attach_trace_metadata({}, "run_001:branch_001:leaf_001", "Leaf_Builder", "Leaf_Builder")
    ...
    def test_attach_metadata_with_additional_metadata(self):
        ...
        result = module.attach_trace_metadata(
            {}, "run_001:branch_001:leaf_001", "Leaf_Builder", "Leaf_Builder", metadata=additional_metadata
        )
...
class TestPropagateTraceId:
    ...
    def test_propagate_trace_id_to_artifact(self):
        ...
        result = module.propagate_trace_id(trace_id, artifact, CanonicalRole.LEAF_BUILDER)
    ...
    def test_propagate_trace_id_preserves_artifact_content(self):
        ...
        result = module.propagate_trace_id("run_001:branch_001:leaf_001", artifact, CanonicalRole.LEAF_BUILDER)
    ...
    def test_propagate_trace_id_fails_for_unauthorized_role(self):
        ...
        result = module.propagate_trace_id("run_001:branch_001:leaf_001", {}, CanonicalRole.INTAKE_CLARIFIER)
    ...
    def test_propagate_trace_id_overwrites_existing_trace_id(self):
        ...
        module = RoleTraceValidationModule()
        artifact = {"_trace_metadata": {"trace_id": "run_001:branch_001:leaf_001"}}
        new_trace_id = "run_002:branch_002:leaf_002"

        result = module.propagate_trace_id(new_trace_id, artifact, CanonicalRole.LEAF_BUILDER)
    ...
    def test_propagate_trace_id_allowed_for_all_roles(self):
        ...
        for role in CanonicalRole:
            result = module.propagate_trace_id("run_001:branch_001:leaf_001", {}, role)
            assert result["_trace_metadata"]["trace_id"] == "run_001:branch_001:leaf_001"
...
class TestExtractTraceMetadata:
    ...
    def test_extract_metadata_from_artifact(self):
        ...
        artifact = module.attach_trace_metadata(
            {}, "run_001:branch_001:leaf_001", "Leaf_Builder", "Leaf_Builder", "execute_task"
        )
...
class TestValidateTraceMetadataConsistency:
    ...
    def test_validate_consistent_metadata(self):
        ...
        module = RoleTraceValidationModule()
        trace_id = "run_001:branch_001:leaf_001"
        artifact = module.attach_trace_metadata({}, trace_id, "Leaf_Builder", "Leaf_Builder")
    ...
    def test_validate_inconsistent_metadata(self):
        ...
        module = RoleTraceValidationModule()
        artifact = module.attach_trace_metadata({}, "run_001:branch_001:leaf_001", "Leaf_Builder", "Leaf_Builder")

        result = module.validate_trace_metadata_consistency(artifact, "run_002:branch_002:leaf_002")
        assert result is False
    ...
    def test_validate_missing_metadata(self):
        ...
        result = module.validate_trace_metadata_consistency(artifact, "run_001:branch_001:leaf_001")
        assert result is False
...
class TestGetViolationHistory:
    ...
    def test_get_violation_history(self):
        ...
        module.validate_operation_for_role(
            CanonicalRole.LEAF_BUILDER, OperationCategory.VERIFY_RESULT, "run_001:branch_001:leaf_002"
        )
    ...
    def test_get_violations_for_operation(self):
        ...
        module.validate_operation_for_role(
            CanonicalRole.LEAF_BUILDER, OperationCategory.EXECUTE_TASK, "run_001:branch_001:leaf_002"
        )
    ...
    def test_get_violations_by_trace_id(self):
        ...
        module.validate_operation_for_role(CanonicalRole.INTAKE_CLARIFIER, OperationCategory.EXECUTE_TASK, trace_id)
        module.validate_operation_for_role(CanonicalRole.INTAKE_CLARIFIER, OperationCategory.VERIFY_RESULT, trace_id)
...
class TestEdgeCases:
    ...
    def test_operation_with_empty_trace_id(self):
        ...
        module = RoleTraceValidationModule()
        result = module.validate_operation_for_role(CanonicalRole.LEAF_BUILDER, OperationCategory.EXECUTE_TASK, "")
        assert result is True
    ...
    def test_propagate_trace_id_with_empty_artifact(self):
        ...
        module = RoleTraceValidationModule()
        result = module.propagate_trace_id("run_001:branch_001:leaf_001", {}, CanonicalRole.LEAF_BUILDER)
        assert result["_trace_metadata"]["trace_id"] == "run_001:branch_001:leaf_001"
    ...
    def test_multiple_violations_for_same_role(self):
        ...
        for i in range(5):
            module.validate_operation_for_role(
                CanonicalRole.INTAKE_CLARIFIER, OperationCategory.EXECUTE_TASK, f"run_001:branch_001:leaf_{i:03d}"
            )
