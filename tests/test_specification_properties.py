...
project_name_strategy = st.text(
    alphabet=st.characters(blacklist_categories=("Cc", "Cs")), min_size=1, max_size=500
).filter(lambda x: x.strip() != "")

project_description_strategy = st.text(
    alphabet=st.characters(blacklist_categories=("Cc", "Cs")), min_size=1, max_size=2000
).filter(lambda x: x.strip() != "")

scope_strategy = st.one_of(st.none(), st.text(min_size=1, max_size=500).filter(lambda x: x.strip() != ""))

constraints_strategy = st.lists(st.text(min_size=1, max_size=200).filter(lambda x: x.strip() != ""), max_size=10)
...
class TestSpecificationParsingProperties:
    ...
    def test_specification_has_valid_run_id_format(
        self, project_name, project_description, scope, constraints, resources, metadata
    ):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_has_all_required_fields(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_domains_are_valid(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_dependencies_are_valid(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_created_at_is_recent(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_scope_is_non_empty(self, project_name, project_description):
    ...
    def test_specification_preserves_provided_constraints(self, project_name, project_description, constraints):
    ...
    def test_specification_preserves_provided_resources(self, project_name, project_description, resources):
    ...
    @given(
        project_name=project_name_strategy, project_description=project_description_strategy, metadata=metadata_strategy
    )
    def test_specification_preserves_provided_metadata(self, project_name, project_description, metadata):
        ...
        **Validates: Requirements 1**
        ...
        intake = IntakeNode()
        request = UserRequest(
            project_name=project_name, project_description=project_description, metadata=metadata if metadata else None
        )
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_run_id_uniqueness(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_backend_always_present(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_frontend_always_present(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_frontend_depends_on_backend(self, project_name, project_description):
    ...
    @given(project_name=project_name_strategy, project_description=project_description_strategy)
    def test_specification_backend_has_no_dependencies(self, project_name, project_description):
