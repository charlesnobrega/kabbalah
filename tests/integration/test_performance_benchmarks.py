...
from src.kabbalah.observability.observability_module import LogLevel, ObservabilityModule, OperationStatus
...
class TestPerformanceBenchmarks:
    ...
    def test_orchestration_decomposition_performance(self):
        ...
        request = UserRequest(
            ...
            project_description=(
                "Build a scalable e-commerce platform with payment processing, " "inventory management, and analytics"
            ),
