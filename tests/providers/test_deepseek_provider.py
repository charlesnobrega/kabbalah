...
Tests the DeepSeekProvider implementation with real API calls.
"""
...
from src.kabbalah.providers import DeepSeekProvider, ProviderResponse
...
class TestDeepSeekProvider:
    ...
    def test_calculate_cost(self, provider):
        ...
        cost = provider.calculate_cost(1000, "deepseek-chat")
