...
Tests the OpenAIProvider implementation with real API calls.
"""
...
from src.kabbalah.providers import OpenAIProvider, ProviderResponse
...
class TestOpenAIProvider:
    ...
    def test_multiple_requests(self, provider):
        ...
        for i in range(2):  # Reduced to avoid excessive costs
            request = {
                "model": "gpt-3.5-turbo",
                "messages": [
        ...
        stats = provider.get_stats()
        # Allow either successful calls or errors
