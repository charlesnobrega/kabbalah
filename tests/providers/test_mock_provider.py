...
class TestMockProvider:
    ...
    def test_execute_request_success(self):
        ...
        provider = MockProvider(response_type=MockResponseType.SUCCESS, response_content="Hello, world!")
    ...
    def test_execute_request_error(self):
        ...
        provider = MockProvider(response_type=MockResponseType.ERROR, error_message="Mock error occurred")
    ...
    def test_execute_request_timeout(self):
        ...
        provider = MockProvider(response_type=MockResponseType.TIMEOUT)
    ...
    def test_execute_request_rate_limit(self):
        ...
        provider = MockProvider(response_type=MockResponseType.RATE_LIMIT)
    ...
    def test_stream_request_success(self):
        ...
        provider = MockProvider(
            response_type=MockResponseType.SUCCESS, response_content="Hello, world!", latency_ms=50.0
        )
    ...
    def test_stream_request_error(self):
        ...
        provider = MockProvider(response_type=MockResponseType.ERROR, error_message="Stream error")
    ...
    def test_statistics_tracking(self):
        ...
        provider = MockProvider(response_type=MockResponseType.SUCCESS, response_content="Test response")
