...
from kabbalah.contract_enforcement import ContractEnforcementModule, OperationContract
...
class TestRegisterContract:
    ...
    def test_register_contract_stores_contract(self):
        ...
        contract = OperationContract(
            operation_name="test_op", preconditions=[precond], postconditions=[], output_parser=None
        )
    ...
    def test_register_multiple_contracts(self):
        ...
        contract1 = OperationContract(
            operation_name="op1", preconditions=[precond], postconditions=[], output_parser=None
        )

        contract2 = OperationContract(
            operation_name="op2", preconditions=[precond], postconditions=[], output_parser=None
        )
...
class TestValidatePreconditions:
    ...
    def test_precondition_passes_when_valid(self):
        ...
        is_valid, error = module.validate_preconditions("test_op", {"value": 5}, "run_001:branch_001:leaf_001")
    ...
    def test_precondition_violation_logged(self):
        ...
        module.validate_preconditions("test_op", {"value": -5}, "run_001:branch_001:leaf_001")
    ...
    def test_multiple_preconditions_all_checked(self):
        ...
        contract = OperationContract(
            operation_name="test_op", preconditions=[precond1, precond2], postconditions=[], output_parser=None
        )
        ...
        is_valid, error = module.validate_preconditions(
            "test_op", {"value": -5, "name": "test"}, "run_001:branch_001:leaf_001"
        )
    ...
    def test_precondition_with_no_contract_returns_true(self):
        ...
        is_valid, error = module.validate_preconditions("unknown_op", {"value": -5}, "run_001:branch_001:leaf_001")
...
class TestValidatePostconditions:
    ...
    def test_postcondition_passes_when_valid(self):
        ...
        contract = OperationContract(
            operation_name="test_op", preconditions=[], postconditions=[postcond], output_parser=None
        )

        module.register_contract(contract)

        is_valid, error = module.validate_postconditions("test_op", {"result": 10}, "run_001:branch_001:leaf_001")
    ...
    def test_postcondition_violation_logged(self):
        ...
        module.validate_postconditions("test_op", {"result": 10}, "run_001:branch_001:leaf_001")
    ...
    def test_postcondition_with_no_contract_returns_true(self):
        ...
        is_valid, error = module.validate_postconditions("unknown_op", {"result": 10}, "run_001:branch_001:leaf_001")
...
class TestValidateOutputParser:
    ...
    def test_parser_passes_when_valid(self):
        ...
        contract = OperationContract(
            operation_name="test_op", preconditions=[], postconditions=[], output_parser=parser
        )

        module.register_contract(contract)

        result = module.validate_output_parser("test_op", {"data": {"key": "value"}}, "run_001:branch_001:leaf_001")
    ...
    def test_parser_fails_when_invalid(self):
        ...
        result = module.validate_output_parser("test_op", {"data": "not a dict"}, "run_001:branch_001:leaf_001")
    ...
    def test_parser_violation_logged(self):
        ...
        module.validate_output_parser("test_op", {"data": "test"}, "run_001:branch_001:leaf_001")
    ...
    def test_parser_with_no_contract_returns_valid(self):
        ...
        result = module.validate_output_parser("unknown_op", {"data": "test"}, "run_001:branch_001:leaf_001")
    ...
    def test_parser_with_no_parser_defined_returns_valid(self):
        ...
        contract = OperationContract(operation_name="test_op", preconditions=[], postconditions=[], output_parser=None)

        module.register_contract(contract)

        result = module.validate_output_parser("test_op", {"data": "test"}, "run_001:branch_001:leaf_001")
...
class TestViolationQueries:
    ...
    def test_get_violations_by_type(self):
        ...
        contract = OperationContract(
            operation_name="test_op", preconditions=[precond], postconditions=[postcond], output_parser=None
        )
