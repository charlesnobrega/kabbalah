...
class SpecificationPrettyPrinter:
    ...
    def pretty_print(
        ...
        try:
            ...
            raise FormattingError(f"Failed to format specification: {str(e)}") from e
    ...
    def _format_yaml(self, specification: Dict[str, Any]) -> str:
        ...
        try:
            ...
            raise FormattingError("YAML support requires PyYAML to be installed") from exc
        except Exception as e:
            raise FormattingError(f"YAML formatting failed: {str(e)}") from e
