...
class IntakeNode:
    ...
    def parse_request(self, request: UserRequest) -> Tuple[Specification, str]:
        ...
        if traducao.bloqueado:
            raise InvalidRequestError("Request blocked by local translator risk classification")
    ...
    def _generate_specification(self, request: UserRequest, run_id: str, traducao=None) -> Specification:
        ...
        try:
            ...
            raise SpecificationError(f"Failed to generate specification: {str(e)}") from e
    ...
    def _generate_default_constraints(self) -> list:
        ...
        return ["Must follow best practices", "Must include error handling", "Must be maintainable"]

    def _generate_default_resources(self) -> dict:
        """Generate default resources."""
        return {"max_tokens": 4000, "timeout_seconds": 300, "retry_count": 3}
