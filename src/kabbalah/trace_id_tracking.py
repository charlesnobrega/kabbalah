...
class TraceIDGenerator:
    ...
    def generate_run_id(cls) -> str:
        ...
        try:
            ...
            raise TraceIDError(f"Failed to generate run_id: {str(e)}") from e
    ...
    def generate_branch_id(cls, domain: str) -> str:
        ...
        try:
            ...
            raise TraceIDError(f"Failed to generate branch_id: {str(e)}") from e
    ...
    def generate_leaf_id(cls, domain: str) -> str:
        ...
        try:
            ...
            raise TraceIDError(f"Failed to generate leaf_id: {str(e)}") from e
    ...
    def construct_trace_id(cls, run_id: str, branch_id: str, leaf_id: str) -> str:
        ...
        try:
            ...
            raise TraceIDError(f"Failed to construct trace_id: {str(e)}") from e
    ...
    def parse_trace_id(cls, trace_id: str) -> Tuple[str, str, str]:
        ...
        try:
            ...
            raise TraceIDError(f"Failed to parse trace_id: {str(e)}") from e
...
class ExecutionLog:
    ...
    def append_entry(
        ...
        try:
            ...
            raise ExecutionLogError(f"Failed to append entry: {str(e)}") from e
    ...
    def get_entries_by_trace_id(self, trace_id: str) -> List[ExecutionLogEntry]:
        ...
        try:
            ...
            raise ExecutionLogError(f"Failed to get entries: {str(e)}") from e
    ...
    def get_entries_by_run_id(self, run_id: str) -> List[ExecutionLogEntry]:
        ...
        try:
            ...
            raise ExecutionLogError(f"Failed to get entries by run_id: {str(e)}") from e
    ...
    def get_entries_by_branch_id(self, branch_id: str) -> List[ExecutionLogEntry]:
        ...
        try:
            ...
            raise ExecutionLogError(f"Failed to get entries by branch_id: {str(e)}") from e
    ...
    def get_entries_by_leaf_id(self, leaf_id: str) -> List[ExecutionLogEntry]:
        ...
        try:
            ...
            raise ExecutionLogError(f"Failed to get entries by leaf_id: {str(e)}") from e
    ...
    def get_entries_by_operation_type(self, operation_type: str) -> List[ExecutionLogEntry]:
        ...
        try:
            ...
            raise ExecutionLogError(f"Failed to get entries by operation_type: {str(e)}") from e
    ...
    def get_entries_by_status(self, status: str) -> List[ExecutionLogEntry]:
        ...
        try:
            ...
            raise ExecutionLogError(f"Failed to get entries by status: {str(e)}") from e
