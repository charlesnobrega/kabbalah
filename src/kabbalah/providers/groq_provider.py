...
Implements the BaseProvider interface for Groq's models.
"""
...
class GroqProvider(BaseProvider):
    ...
    Supports:
    - mixtral-8x7b-32768 (recommended for most tasks)
    - llama2-70b-4096
    - gemma-7b-it
    """
    ...
    def execute_request(self, request: Dict, timeout: float = 30.0) -> ProviderResponse:
        """
        Execute a request to Groq.
        ...
        model_name = request.get("model", "mixtral-8x7b-32768")
    ...
    def stream_request(self, request: Dict, timeout: float = 30.0) -> Iterator[ProviderResponse]:
        """
    ...
    def validate_request(self, request: Dict) -> bool:
        ...
        model = request.get("model", "mixtral-8x7b-32768")
