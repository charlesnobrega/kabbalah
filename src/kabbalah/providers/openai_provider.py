...
Implements the BaseProvider interface for OpenAI's models.
"""
...
class OpenAIProvider(BaseProvider):
    ...
    def __init__(self, api_key: Optional[str] = None, **kwargs):
        ...
        Args:
            api_key: OpenAI API key (or use vault/secrets_vault.py)
    ...
    def execute_request(self, request: Dict, timeout: float = 30.0) -> ProviderResponse:
        ...
        model_name = request.get("model", "gpt-4o")
        ...
        try:
            ...
            for chunk in response:
                ...
                if chunk.choices and chunk.choices[0].delta.content:
                    ...
                    # Estimate tokens (OpenAI doesn't provide token counts in stream)
