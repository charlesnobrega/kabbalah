...
class ProviderFactory:
    ...
    def create_provider(self, provider_name: str, api_key: Optional[str] = None, **kwargs) -> BaseProvider:
        """
        ...
        if provider_name not in self.PROVIDERS:
            raise ValueError(f"Unknown provider: {provider_name}. " f"Available: {list(self.PROVIDERS.keys())}")
    ...
    def set_configuration_mode(self, mode: ConfigurationMode, config: Optional[Dict] = None) -> None:
        """
    ...
    def set_fallback_chain(self, role: str, providers: List[str]) -> None:
        """
