...
class ToolExecutionEngine:
    ...
    def __init__(
        ...
        self.enable_bash = (
            os.environ.get("KABBALAH_TOOLS_ENABLE_BASH", "1") == "1" if enable_bash is None else bool(enable_bash)
        )
    ...
    def _execute_bash(self, request: ToolRequest) -> ToolResponse:
        ...
        try:
            ...
            raise ToolTimeoutError(f"Command timed out after {request.timeout} seconds") from exc
    ...
    def _stream_bash(self, request: ToolRequest, start_time: float) -> Iterator[ToolResponse]:
    ...
    def _execute_grep(self, request: ToolRequest) -> ToolResponse:
        ...
        try:
            ...
            raise ToolTimeoutError(f"Grep timed out after {request.timeout} seconds") from exc
    ...
    def _stream_grep(self, request: ToolRequest, start_time: float) -> Iterator[ToolResponse]:
    ...
    def _execute_web(self, request: ToolRequest) -> ToolResponse:
        ...
        try:
            ...
            raise ToolExecutionError("requests library not installed") from exc
        ...
        try:
            ...
            raise ToolTimeoutError(f"Web request timed out after {request.timeout} seconds") from exc
